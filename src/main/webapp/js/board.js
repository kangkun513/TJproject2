...
//		searchFunction()
//	}
//	onload = () => boardshowFunction()

function setting(mode, title) {
	var fm = document.form49
	console.log(fm)
	// 1 → 댓글 수정, 2 → 답글 작성
	//fm.mode.value = mode
...
function commentUpdateForm() {
	// var con = document.getElementById('').getElementById('commentUpdateForm').style.display
	console.log('commentUpdateForm()')
	console.log(document.getElementById('comidx').value)
	console.log(con)
	
	document.getElementById('commentUpdateForm').style.display = "flex"
}
