...
ArrayList<MainVO> selectHit = MainService.getInstance().selectHit(); // 공지글
// MainList mainHit = MainService.getInstance().selectHit(currentPage);

// 메인글을 request 영역에 저장해서 메인글을 브라우저에 표시하는 페이지(Main.jsp)로
// 넘겨준다.
