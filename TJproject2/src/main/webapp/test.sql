...
INSERT INTO main (idx, subject, content, gup, category, id) VALUES (main_idx_seq.nextval, '1등', '1등으로 적은 글의 내용입니다.', main_idx_seq.currval, '카테고리1', 'hong');
INSERT INTO main (idx, subject, content, gup, category, id) VALUES (main_idx_seq.nextval, '2등', '2등으로 적은 글의 내용입니다.', main_idx_seq.currval, '카테고리2', 'lim');
INSERT INTO main (idx, subject, content, gup, category, id) VALUES (main_idx_seq.nextval, '3등', '3등으로 적은 글의 내용입니다.', main_idx_seq.currval, '카테고리3', 'jang');
INSERT INTO main (idx, subject, content, gup, category, id) VALUES (main_idx_seq.nextval, '4등', '4등으로 적은 글의 내용입니다.', main_idx_seq.currval, '카테고리4', 'ill');
INSERT INTO main (idx, subject, content, gup, category, id) VALUES (main_idx_seq.nextval, '5등', '5등으로 적은 글의 내용입니다.', main_idx_seq.currval, '카테고리5', 'kim');
INSERT INTO main (idx, subject, content, gup, category, id) VALUES (main_idx_seq.nextval, '6등', '6등으로 적은 글의 내용입니다.', main_idx_seq.currval, '카테고리6', 'lee');
INSERT INTO main (idx, subject, content, gup, category, id) VALUES (main_idx_seq.nextval, '7등', '7등으로 적은 글의 내용입니다.', main_idx_seq.currval, '카테고리7', 'bae');
INSERT INTO main (idx, subject, content, gup, category, id) VALUES (main_idx_seq.nextval, '8등', '8등으로 적은 글의 내용입니다.', main_idx_seq.currval, '카테고리8', 'kang');
